...
import 'package:winpay/ui/home/otpScreen.dart';
...
class _DepositScreenState extends State<DepositScreen> {
  ...
  Future<void> withdrawMoney(String bankId, double moneyAdd) async {
    setState(() {
    ...
    try {
      final token = Global.token;
      final url =
      Uri.parse('${AppEnv.baseURL}consumer/wallet/init-deposit');
      ...
      if (response.statusCode == 204) {
        ...
        Global.moneyRequest.moneyAdd = moneyAdd;
        Global.moneyRequest.bankId = bankId;
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              content: const Text('Your Deposit request has been processed.'),
              actions: <Widget>[
                TextButton(
                  child: const Text('OK'),
                  onPressed: () {
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              content: const Text('Insufficient funds. Please check your balance.'),
              actions: <Widget>[
                TextButton(
                  child: const Text('OK'),
                  onPressed: () {
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              title: const Text('Deposit Failed'),
              content: const Text('Your Wallet was limit.'),
              actions: <Widget>[
                TextButton(
                  child: const Text('OK'),
                  onPressed: () {
