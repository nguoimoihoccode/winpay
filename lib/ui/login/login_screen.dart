...
import 'package:winpay/ui/auth/initotp.dart';
import 'package:winpay/ui/auth/initotpResetPassword.dart';
              ...
              InkWell(
                onTap: () async {
                  ...
                  if (email.isNotEmpty && password.isNotEmpty) {
                    ...
                    String loginJson = jsonEncode(loginData);

                    // Gọi API
                    var url = Uri.parse('${AppEnv.baseURL}consumer/authenticate');
                    ...
                    if (response.statusCode == 200) {
                      ...
                      Global.setToken(responseData['token']);
                      print(Global.token);
                      ...
                      showDialog(
                        ...
                        builder: (context) {
                          return AlertDialog(
                            ...
                            content: const Text('You fill incorrect username or password.'),
                            actions: <Widget>[
                              TextButton(
                                onPressed: () {
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const InitOtp()),
                      );
                    },
                    child: const Text(
                      'Register',
