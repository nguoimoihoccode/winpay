...
class OtpWaterScreen extends StatefulWidget {
  const OtpWaterScreen({super.key});

  @override
  State<OtpWaterScreen> createState() => _OtpWaterScreenState();
}

class _OtpWaterScreenState extends State<OtpWaterScreen> {
  ...
  Future<void> sendValidation(String otp) async {
    final url = '${AppEnv.baseURL}consumer/water-bill/pay-done';
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: const Text('YOU COMPLETE PAYMENT WATER BILL!'),
          actions: <Widget>[
            TextButton(
              onPressed: () {
