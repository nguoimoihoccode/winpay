...
class OtpInternetScreen extends StatefulWidget {
  const OtpInternetScreen({super.key});

  @override
  State<OtpInternetScreen> createState() => _OtpInterNetScreenState();
}

class _OtpInterNetScreenState extends State<OtpInternetScreen> {
  ...
  Future<void> sendValidation(String otp) async {
    final url = '${AppEnv.baseURL}consumer/internet-bill/pay-done';
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: const Text('YOU COMPLETE PAYMENT INTERNET BILL!'),
          actions: <Widget>[
            TextButton(
              onPressed: () {
