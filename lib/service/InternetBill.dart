...
import 'package:winpay/service/otp/otpInternetBillScreen.dart';
...
class _InternetBillScreenState extends State<InternetBillScreen> {
  final String apiUrl = '${AppEnv.baseURL}consumer/internet-bill';
  final String payInitUrl = '${AppEnv.baseURL}consumer/internet-bill/pay-init';
  ...
  Future<void> handlePayment() async {
    ...
    try {
      ...
      if (response.statusCode == 204) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => const OtpInternetScreen()),
        );
