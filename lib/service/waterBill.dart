...
import 'package:winpay/service/otp/otpWaterBillScreen.dart';
...
class _WaterBillScreenState extends State<WaterBillScreen> {
  final String apiUrl = '${AppEnv.baseURL}consumer/water-bill';
  final String payInitUrl = '${AppEnv.baseURL}consumer/water-bill/pay-init';
  ...
  Future<void> handlePayment() async {
    ...
    try {
      ...
      if (response.statusCode == 204) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => const OtpWaterScreen()),
        );
